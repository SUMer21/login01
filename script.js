...
function areaConvert() {
    ...
    let addAreaOptions1 =  document.getElementById('inputUnit');
    let addAreaOptions2 =  document.getElementById('outputUnit');
    ...
    document.getElementById('conversionForm').addEventListener('submit', function(event) {
        ...
        let outputValue = 0;
            ...
            if (inputUnit == 'squareMeter' && outputUnit == 'squareMeter') {
                outputValue = inputValue;
            } else if (inputUnit == 'squareMeter' && outputUnit == 'squareKilometer') {
                outputValue = ( inputValue *  (0.000001) ) ; 
            } else if (inputUnit == 'squareMeter' && outputUnit == 'squareCentimeter') {
                outputValue = ( inputValue * 10000 );  
            } else if (inputUnit == 'squareMeter' && outputUnit == 'hectare') {
                outputValue = ( inputValue / 10000 ); // 1 hectare = 10,000 square meters
            } else if (inputUnit == 'squareMeter' && outputUnit == 'acre') {
                outputValue = ( inputValue * 0.000247105 ); // 1 acre = 4046.85642 square meters
            } else if (inputUnit == 'squareKilometer' && outputUnit == 'squareMeter') {
                outputValue = ( inputValue * 1000000 ); 
            } else if (inputUnit == 'squareKilometer' && outputUnit == 'squareKilometer') {
                outputValue = inputValue;
            } else if (inputUnit == 'squareKilometer' && outputUnit == 'squareCentimeter') {
                outputValue = ( inputValue * 10000000000 ); 
            } else if (inputUnit == 'squareKilometer' && outputUnit == 'hectare') {
                outputValue = ( inputValue * 100 ); 
            } else if (inputUnit == 'squareKilometer' && outputUnit == 'acre') {
                outputValue = ( inputValue * 247.105 ); 
            } else if (inputUnit == 'squareCentimeter' && outputUnit == 'squareMeter') {
                outputValue = ( inputValue / 10000 ); 
            } else if (inputUnit == 'squareCentimeter' && outputUnit == 'squareKilometer') {
                outputValue =  ( inputValue / 10000000000 );  
            } else if (inputUnit == 'squareCentimeter' && outputUnit == 'squareCentimeter') {
                outputValue = inputValue;
            } else if (inputUnit == 'squareCentimeter' && outputUnit == 'hectare') {
                outputValue = ( inputValue / 100000000 ); // 1 hectare = 10,000,000 square centimeters
            } else if (inputUnit == 'squareCentimeter' && outputUnit == 'acre') {
                outputValue =(  inputValue * 2.47105e-8 ); // 1 acre = 40468564.2 square centimeters
            } else if (inputUnit == 'hectare' && outputUnit == 'squareMeter') {
                outputValue = ( inputValue * 10000 ); // 1 hectare = 10,000 square meters
            } else if (inputUnit == 'hectare' && outputUnit == 'squareKilometer') {
                outputValue = ( inputValue * 0.01 );  
            } else if (inputUnit == 'hectare' && outputUnit == 'squareCentimeter') {
                outputValue =  (inputValue * 100000000 ); // 1 hectare = 10,000,000 square centimeters
            } else if (inputUnit == 'hectare' && outputUnit == 'hectare') {
                outputValue = inputValue;
            } else if (inputUnit == 'hectare' && outputUnit == 'acre') {
                outputValue =  ( inputValue * 2.47105 ); // 1 acre = 0.404685642 hectares
            } else if (inputUnit == 'acre' && outputUnit == 'squareMeter') {
                outputValue = ( inputValue * 4046.85642 ); // 1 acre = 4046.85642 square meters
            } else if (inputUnit == 'acre' && outputUnit == 'squareKilometer') {
                outputValue = ( inputValue * 0.00404685642 );  
            } else if (inputUnit == 'acre' && outputUnit == 'squareCentimeter') {
                outputValue = ( inputValue * 40468564.2 );
            } else {
                outputValue = ( inputValue * 0.404685642 ); 
            } 
...
function timeConvert() {
    ...
    const addTimeOption1 = document.getElementById('inputUnit');
    const addTimeOption2 = document.getElementById('outputUnit');


    addTimeOption1.innerHTML = '';
    addTimeOption2.innerHTML = '';

    const second = document.createElement('option');
    const milliSecond = document.createElement('option');
    const microSecond = document.createElement('option');
    const nanoSecond = document.createElement('option');
    const minute = document.createElement('option');
    const hour = document.createElement('option');


    const second2 = document.createElement('option');
    const milliSecond2 = document.createElement('option');
    const microSecond2 = document.createElement('option');
    const nanoSecond2 = document.createElement('option');
    const minute2 = document.createElement('option');
    const hour2 = document.createElement('option');
    ...
    milliSecond2.value = 'milliSecond';
    microSecond2.value = 'microSecond';
    nanoSecond2.value = 'nanoSecond';
    minute2.value = 'minute';
    hour2.value = 'hour';


    second.textContent = 'Second';
    milliSecond.textContent = 'Milli Second';
    microSecond.textContent = 'Micro Second';
    nanoSecond.textContent = 'Nano Second';
    minute.textContent = 'Minute';
    hour.textContent = 'Hour';

    second2.textContent = 'Second';
    milliSecond2.textContent = 'Milli Second';
    microSecond2.textContent = 'Micro Second';
    nanoSecond2.textContent = 'Nano Second';
    minute2.textContent = 'Minute';
    hour2.textContent = 'Hour';


    addTimeOption1.appendChild(second);
    addTimeOption1.appendChild(milliSecond);
    addTimeOption1.appendChild(microSecond);
    addTimeOption1.appendChild(nanoSecond);
    addTimeOption1.appendChild(minute);
    addTimeOption1.appendChild(hour);


    addTimeOption2.appendChild(milliSecond2);
    addTimeOption2.appendChild(second2);
    addTimeOption2.appendChild(microSecond2);
    addTimeOption2.appendChild(nanoSecond2);
    addTimeOption2.appendChild(minute2);
    addTimeOption2.appendChild(hour2);
